...
#pragma warning disable CA1515 // Consider making public types internal
    public class AutoMapperTests(ILoggerFactory loggerFactory)
#pragma warning restore CA1515 // Consider making public types internal
    {
        [Fact]
        public void Mapping_Configuration_Should_Be_Valid()
        {
            MapperConfiguration config = new(cfg => cfg.AddMaps(typeof(InfrastructureMappingProfile)), loggerFactory);
