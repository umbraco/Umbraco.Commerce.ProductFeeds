...
// export const UC_EMAIL_TEMPLATE_STORE_CONTEXT = new UmbContextToken<UcpfStore>(WORKSPACE_STORE_ALIAS);

// export class UcpfStore extends UmbStoreBase<ProductFeedSettingReadModel> {
