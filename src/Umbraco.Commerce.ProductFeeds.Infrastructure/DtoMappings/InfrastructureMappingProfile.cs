    ...
    public class InfrastructureMappingProfile : Profile
    {
        public InfrastructureMappingProfile()
        {
            CreateMap<ProductFeedSettingWriteModel, UmbracoCommerceProductFeedSetting>()
                ...
                .ForMember(dest => dest.FeedType, opt => opt.MapFrom((src, dest) => src.FeedGeneratorId ?? src.FeedType?.ToString())) // TODO: Rename FeedType to FeedGeneratorId or similar
            ...
            CreateMap<UmbracoCommerceProductFeedSetting, ProductFeedSettingReadModel>()
                .ForMember(dest => dest.FeedType, opt => opt.MapFrom((src, dest) => Enum.Parse<ProductFeedType>(src.FeedType))) // TODO: Rename FeedType to FeedGeneratorId or similar
